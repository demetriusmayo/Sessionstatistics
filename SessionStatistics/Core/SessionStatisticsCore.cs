...
namespace SessionStatistics
{
    public class SessionStatisticsCore : BaseSettingsPlugin<Core.SessionStatisticsSettings>
    {
        ...
        public override void Render()
        {
            ...
            {
                if (Visuals.DropBoard.Instance.ShouldBeShown && !GameController.Game.IngameState.IngameUi.OpenLeftPanel.IsVisible && !GameController.Game.IngameState.IngameUi.OpenRightPanel.IsVisible)
                {
                    Visuals.DropBoard.Instance.Draw(new SharpDX.Vector2(SessionStatisticsCore.SettingsInstance.DropBoardXPos, SessionStatisticsCore.SettingsInstance.DropBoardYPos));
                }
