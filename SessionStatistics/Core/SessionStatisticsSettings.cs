...
namespace SessionStatistics.Core
{
    public class SessionStatisticsSettings : SettingsBase
    {
        ...
        [Menu("Drop X-Position")]
        public RangeNode<float> DropBoardXPos { get; set; }
        [Menu("Drop Y-Position")]
        public RangeNode<float> DropBoardYPos { get; set; }
        [Menu("DropBoardRowHeight")]
        public RangeNode<Int32> DropBoardRowHeight { get; set; }
        [Menu("DropBoardRowWidth")]
        public RangeNode<Int32> DropBoardRowWidth { get; set; }
        [Menu("DropBoardNeededWidth")]
        public RangeNode<Int32> DropBoardNeededWidth { get; set; }
        ...
        public SessionStatisticsSettings()
        {
            ...
            DropBoardXPos = new RangeNode<float>(0, 0, SessionStatisticsCore.API.GameController.Window.GetWindowRectangle().BottomRight.X);
            DropBoardYPos = new RangeNode<float>(0, 0, SessionStatisticsCore.API.GameController.Window.GetWindowRectangle().BottomRight.Y);
            DropBoardRowHeight = new RangeNode<int>(48, 1, 200);
            DropBoardRowWidth = new RangeNode<int>(60, 1, 200);
            DropBoardNeededWidth = new RangeNode<int>(170, 1, 500);
